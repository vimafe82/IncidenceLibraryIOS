...
public final class BottomSheetPresentationController: UIPresentationController {
  ...
  private lazy var dimmingView: UIView = {
    let view = UIView()
    view.backgroundColor = UIColor.app(.black600)
    return view
  }()
  ...
  @objc private func onTapAction() {
      ...
      guard let presentedController = presentedViewController as? BottomSheetViewController else { return }
    
      if (presentedController.canHide) {
