...
///   ```
///     var config = IncidenceLibraryConfig()
///     config.isLocalStorageEnabled = false
///     config.channel.keystrokeEventTimeout = 15
///   ```
///
public struct IncidenceLibraryConfig {
    ...
    /// Creates a new instance of `IncidenceLibraryConfig`.
    ///
...
extension IncidenceLibraryConfig {
    /// Creates a new instance of `IncidenceLibraryConfig`.
    ///
